...
public class Adaptador extends RecyclerView.Adapter<Adaptador.AcontecimientoViewHolder>
    ...
    public static class AcontecimientoViewHolder
        ...
        public AcontecimientoViewHolder(View itemView) {
            super(itemView);
            TextView_categoria = (TextView) itemView.findViewById(R.id.spinner);
            TextView_pregunta = (TextView) itemView.findViewById(R.id.PreguntaeditText);
        }
    ...
    public Adaptador(@NonNull ArrayList<Pregunta> items) {
        this.items = items;
    }
